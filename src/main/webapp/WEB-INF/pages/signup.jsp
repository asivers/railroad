...
<div class="container" id="centerform" style="top:30%">
    ...
    <form action="/createuser" method="POST" style="margin-top:10px; margin-bottom:10px">
        ...
        <div class="row" style="margin: 10px 1px -10px;">
            <button type="submit" class="btn btn-success col-sm-8" style="margin-bottom:10px;">Submit registration</button>
