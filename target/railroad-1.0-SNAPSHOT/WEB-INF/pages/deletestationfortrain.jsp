...
<div class="container" id="centerform" style="top:35%">
    ...
    <form action="/finishdeletestationfortrain" method="POST" style="margin-top:10px; margin-bottom:10px">
        ...
        <div class="row" style="margin-left:1px; margin-right:1px">
            <button type="submit" class="btn btn-danger col-sm-3 offset-sm-4" style="margin-bottom:1px;">Delete</button>
